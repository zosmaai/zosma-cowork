			...
			<section className="aurora-bg relative flex flex-col items-center text-center px-4 pt-20 pb-12 sm:pt-28 sm:pb-16">
				...
				<div className="relative z-10 flex flex-col items-center gap-6 max-w-2xl">
					...
					<p
						...
						style={{ maxWidth: "58ch" }}
					>
						Sessions tied to your folders. Streaming responses, tool-call timelines, and 20+ LLM
						providers in one native desktop app — no terminal required.
					</p>
...
const README_LANGS = [
	{
		lang: "English",
		label: "EN",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.md",
	},
	{
		lang: "Chinese",
		label: "中文",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.zh.md",
	},
	{
		lang: "Spanish",
		label: "ES",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.es.md",
	},
	{
		lang: "Japanese",
		label: "日本語",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.ja.md",
	},
	{
		lang: "German",
		label: "DE",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.de.md",
	},
	{
		lang: "French",
		label: "FR",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.fr.md",
	},
	{
		lang: "Portuguese",
		label: "PT",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.pt.md",
	},
	{
		lang: "Russian",
		label: "RU",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.ru.md",
	},
	{
		lang: "Korean",
		label: "한국어",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.ko.md",
	},
	{
		lang: "Hindi",
		label: "हिंदी",
		href: "https://github.com/zosmaai/zosma-cowork/blob/main/README.hi.md",
	},
];
