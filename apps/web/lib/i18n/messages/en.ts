...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.plugins": "Plugins", "common.settings": "Settings", "settings.categories.models": "Models & Providers", "settings.categories.plugins": "Plugins", "settings.categories.skills": "Skills", "settings.categories.appearance": "Appearance", "settings.categories.language": "Language", "settings.categories.defaults": "Defaults",
    "appUpdate.releaseNotes": "zosma.ai v{version} is available. View release notes",
    "auth.brand": "Zosma Harness",
    "auth.signInTitle": "Sign in to Zosma",
    "auth.signInSubtitle": "Continue with your Google account to use Zosma Harness.",
    "auth.continueWithGoogle": "Continue with Google",
    "auth.openingBrowser": "Opening browser…",
    "auth.openingLink": "Opening your sign-in link…",
    "auth.waitingBrowser": "Complete sign-in in your browser, then return here.",
    "auth.completing": "Signing you in…",
    "auth.troublePaste": "Trouble? Paste the result URL",
    "auth.pastePlaceholder": "https://…/callback?code=…&state=…",
    "auth.submit": "Submit",
    "auth.cancel": "Cancel",
    "auth.keyFallback": "Have a Zosma Router key? Use it directly",
    "auth.keyPlaceholder": "Zosma Router key",
    ...
    "session.metrics.counts": "{turns} turns · {steps} steps",
    "session.metrics.tools": "{count} tool calls",
    "session.metrics.active": "Active {duration}",
    "session.metrics.cacheHit": "Cache hit {percent}%",
    "session.metrics.input": "Input {tokens} tok",
    "session.metrics.output": "Output {tokens} tok",
    "session.metrics.context": "Context {percent}%",
    ...
    "workspace.selectSession": "Start a session",
    "workspace.selectSessionHint": "Open one from the sidebar, or create a new session.",
    ...
    "sidebar.searchWorkspaces": "Search workspaces and sessions…",
    "sidebar.clearSearch": "Clear search",
    "sidebar.addFolder": "Add folder…",
    "sidebar.noWorkspaceMatches": "No matching workspaces or sessions",
    "sidebar.noWorkspaces": "No workspaces yet",
    "sidebar.noWorkspacesHint": "Add a folder to start a new session.",
    "sidebar.workspaceEmpty": "No sessions in this workspace yet",
    "sidebar.newSessionCta": "New session",
    ...
    "composer.selectWorkspace": "Workspace for the new session",
    "composer.workspacesLoading": "Loading workspaces…",
    "composer.workspacesError": "Couldn’t load workspaces",
    "composer.workspacesEmpty": "No recent workspaces",
    "composer.addFolder": "Add folder…",
    ...
    "chat.thinkingRunning": "Thinking in progress",
    "chat.thinkingComplete": "Thinking complete",
    "chat.toolRunning": "Running {name}",
    "chat.toolSucceeded": "Completed {name}",
    "chat.toolFailed": "Failed {name}",
    "chat.toolInterrupted": "Interrupted {name}",
    "chat.toolInput": "IN",
    "chat.toolOutput": "OUT",
    "chat.processDetails": "Process details",
    "chat.turnProcess": "Reasoning & tools",
    ...
    "chat.promptSuggestions": "Try one of these",
    "hero.addPower": "Supercharge your workflow",
    "hero.workflows": "Teach the agent how you work",
    ...
    "chat.messagePlaceholder": "Message or run a task, / commands, @ files or sessions",
    "chat.steer": "Steer",
    "chat.followUp": "Follow-up",
    "chat.send": "Send",
    "chat.attachImage": "Attach image",
    "chat.openCommands": "Commands",
