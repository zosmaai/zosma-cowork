...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.models": "模型",
    "common.skills": "技能",
    "common.plugins": "插件", "common.settings": "设置", "settings.categories.models": "模型与提供商", "settings.categories.plugins": "插件", "settings.categories.skills": "技能", "settings.categories.appearance": "外观", "settings.categories.language": "语言", "settings.categories.defaults": "默认设置",
    "appUpdate.releaseNotes": "zosma.ai v{version} 可用，查看更新说明",
    "auth.brand": "Zosma Harness",
    "auth.signInTitle": "登录 Zosma",
    "auth.signInSubtitle": "使用 Google 账号继续使用 Zosma Harness。",
    "auth.continueWithGoogle": "使用 Google 继续",
    "auth.openingBrowser": "正在打开浏览器…",
    "auth.openingLink": "正在打开登录链接…",
    "auth.waitingBrowser": "请在浏览器中完成登录，然后返回此处。",
    "auth.completing": "正在登录…",
    "auth.troublePaste": "遇到问题？粘贴结果链接",
    "auth.pastePlaceholder": "https://…/callback?code=…&state=…",
    "auth.submit": "提交",
    "auth.cancel": "取消",
    "auth.keyFallback": "已有 Zosma Router 密钥？直接使用",
    "auth.keyPlaceholder": "Zosma Router 密钥",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    ...
    "session.modified": "修改时间",
    "session.load": "发送消息或运行 /session 以加载会话信息",
    "session.infoSection": "会话信息",
    "session.messages": "消息",
    "session.tokens": "Token",
    "session.totalActive": "活跃时长",
    "session.metrics.counts": "{turns} 轮 · {steps} 步",
    "session.metrics.tools": "{count} 次工具调用",
    "session.metrics.active": "活跃 {duration}",
    "session.metrics.cacheHit": "缓存命中 {percent}%",
    "session.metrics.input": "输入 {tokens} tok",
    "session.metrics.output": "输出 {tokens} tok",
    "session.metrics.context": "上下文 {percent}%",
    "session.copyFile": "复制文件路径",
    "session.copyId": "复制会话 ID",
    "workspace.opening": "正在打开工作区...",
    "workspace.unable": "无法打开工作区",
    "workspace.selectSession": "开始一个新会话",
    "workspace.selectSessionHint": "从侧边栏打开一个，或创建一个新的会话。",
    ...
    "sidebar.searchWorkspaces": "搜索工作区和会话…",
    "sidebar.clearSearch": "清除搜索",
    "sidebar.addFolder": "添加文件夹…",
    "sidebar.noWorkspaceMatches": "没有匹配的工作区或会话",
    "sidebar.noWorkspaces": "暂无工作区",
    "sidebar.noWorkspacesHint": "添加文件夹以开始新会话。",
    "sidebar.workspaceEmpty": "此工作区还没有会话",
    "sidebar.newSessionCta": "新建会话",
    "sidebar.selectWorkspace": "选择工作区",
    "sidebar.expandWorkspace": "展开工作区",
    "sidebar.collapseWorkspace": "关闭工作区",
    "composer.selectWorkspace": "新会话的工作区",
    "composer.workspacesLoading": "工作区加载中…",
    "composer.workspacesError": "无法加载工作区",
    "composer.workspacesEmpty": "暂无最近工作区",
    "composer.addFolder": "添加文件夹…",
    "sidebar.refresh": "刷新",
    ...
    "chat.thinking": "正在思考...",
    "chat.thinkingRunning": "思考进行中",
    "chat.thinkingComplete": "思考完成",
    "chat.toolRunning": "正在运行{name}",
    "chat.toolSucceeded": "已完成{name}",
    "chat.toolFailed": "{name}失败",
    "chat.toolInterrupted": "已中断{name}",
    "chat.toolInput": "输入",
    "chat.toolOutput": "输出",
    "chat.processDetails": "处理详情",
    "chat.turnProcess": "推理与工具",
    "chat.message": "条消息",
    "chat.messages": "条消息",
    "chat.toolCall": "次工具调用",
    ...
    "chat.promptSuggestions": "试试下面这些",
    "hero.addPower": "为工作流添加超能力",
    "hero.workflows": "教代理你的工作方式",
    "chat.recall": "移回输入框",
    ...
    "chat.steerPlaceholder": "立即引导 / 排队后续…",
    "chat.agentPlaceholder": "Agent 运行中…",
    "chat.messagePlaceholder": "发消息或创建任务, / 调用指令, @ 文件或对话",
    "chat.steer": "引导",
    "chat.followUp": "后续消息",
    "chat.send": "发送",
    "chat.attachImage": "附加图片",
    "chat.openCommands": "命令",
