...
test("all project resource loaders and reloads enforce project trust", async () => {
  ...
  const daemonSkillsSource = await readFile(new URL("../../../apps/daemon/src/read/skills.ts", import.meta.url), "utf8");
  const daemonSkillsServiceSource = await readFile(new URL("../../../apps/daemon/src/read/lib/skills-service.ts", import.meta.url), "utf8");
  const daemonPluginsSource = await readFile(new URL("../../../apps/daemon/src/read/plugins.ts", import.meta.url), "utf8");
