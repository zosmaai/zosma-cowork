...
Zosma Cowork's interface uses a small internal i18n layer. It is intentionally kept
...
/** Zosma Cowork Japanese language package. */
...
Zosma Cowork is a user-facing web interface. Internationalization is therefore an
...
support should lower the barrier to using Zosma Cowork, not be treated as a measure
