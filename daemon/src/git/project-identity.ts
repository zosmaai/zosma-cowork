 ...
 *
 * Faithful port of `web/lib/project-identity.ts`. This key is only for
 * grouping and equality: Windows paths are normalized with win32 rules and
 * case-folded because the default Windows filesystem is case-insensitive. The
 * explicit platform argument keeps those semantics testable on non-Windows CI.
 */
